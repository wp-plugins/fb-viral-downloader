...
class DC_Fb_Viral_Downloader_License {
	
	/**
	 * Self Upgrade Values
	 */
	// Base URL to the remote upgrade API server
	public $upgrade_url = DC_FB_VIRAL_DOWNLOADER_PLUGIN_SERVER_URL; // URL to access the Update API Manager.

	/**
	 * @var string
	 * This version is saved after an upgrade to compare this db version to $version
	 */
	public $api_manager_license_version_name = 'dc-fb-viral-downloader_license_version';
    ...
    global $DC_Fb_Viral_Downloader;
		...
		if ( is_admin() ) {
			 ...
			 */
			$this->license_software_product_id = $DC_Fb_Viral_Downloader->token;

			/**
			 * Set all data defaults here
			 */
			$this->license_product_id_key 			= 'dc_fb_viral_downloader_license_product_id';

			/**
			 * Set all software update data here
			 */
			$this->license_plugin_name 			= 'fb_viral_downloader/fb_viral_downloader.php'; // same as plugin slug. if a theme use a theme name like 'twentyeleven'
			...
			$this->license_software_version 	= $DC_Fb_Viral_Downloader->version; // The software version
	...
	public function activation() {
		global $wpdb, $DC_Fb_Viral_Downloader;
...
function DC_Fb_Viral_Downloader_LICENSE() {
  return DC_Fb_Viral_Downloader_License::instance();
}
